...
let use = 0;
let sec = localStorage.getItem('Eventlist')
let townd = ""
let br = 0;
let sdkg = '';
let tomem = 0;
...
function dateitout(e){
    df = e.split('')
    year = df[0]+df[1]+df[2]+df[3]
    month = df[5]+df[6]
    day = df[8]+df[9]
    return {
        year,month,day
    }}
function find_interest(){
    
    let principal = document.getElementById('Amountp').value;
    let rate = document.getElementById('Ratep').value;
    let time = document.getElementById('Timep').value;
    let interest = (principal * rate * time)/100;
    console.log(principal,time,rate,interest)
    document.getElementById('answer').innerHTML = interest
}
...
recognition.onresult = function (event) {
    ...
    if(transcript.includes('interest')){
        readOut('Okay Sir!')
        pop67()
    }
    ...
    if (transcript.includes("date")) {
        ...
        let monthlb = [" ","January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
    ...
    if(transcript.includes('my event list')){
...
function popl36() {
    document.getElementById('popup365').style.display = "inline-block"
}
function popl365() {
    document.getElementById('popup365').style.display = "none"
}
function popc456() {
    document.getElementById("popup456").style.display = "none"
}
function popk() {
    document.getElementById('popup456').style.display = "inline-block"
}
function popc() {
...
function pop67() {
    document.getElementById('popup97').style.display = "inline-block"
}
function popc67() {
    document.getElementById('popup97').style.display = "none"
}
